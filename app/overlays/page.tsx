      ...
      <div className="bg-gray-800 p-6 rounded-lg mb-8">
        ...
        <form onSubmit={handleSubmit} className="space-y-4">
          ...
          <div>
            ...
            <input id="file-input" type="file" onChange={handleFileChange} accept="image/*" className="w-full text-sm text-gray-400 file:mr-4 file:py-2 file:px-4 file:rounded-md file:border-0 file:text-sm file:font-semibold file:bg-teal-500 file:text-white hover:file:bg-teal-600" />
          </div>
        ...
        {overlays.map(overlay => (
          <div key={overlay.id} className="bg-gray-800 rounded-lg shadow-lg overflow-hidden">
            ...
            <div className="p-4 flex justify-between items-center">
              ...
              <Link href={`/capture/${overlay.id}`} className="bg-blue-500 hover:bg-blue-600 text-white font-bold py-2 px-4 rounded-md" style={{minHeight: '44px', display: 'flex', alignItems: 'center'}}>
                Open Capture
              </Link>
            </div>
          </div>
